...
ref_file_GL_0 = open("ref_GL_Wiley_0.txt", "r")
ref_file_GL_10 = open("ref_GL_Wiley_10.txt", "r")
ref_file_GL_20 = open("ref_GL_Wiley_20.txt", "r")
ref_file_GL_30 = open("ref_GL_Wiley_30.txt", "r")
ref_file_GL_40 = open("ref_GL_Wiley_40.txt", "r")
ref_file_GL_50 = open("ref_GL_Wiley_50.txt", "r")
ref_file_GL_60 = open("ref_GL_Wiley_60.txt", "r")
ref_file_GL_70 = open("ref_GL_Wiley_70.txt", "r")
ref_file_GL_80 = open("ref_GL_Wiley_80.txt", "r")
ref_file_GL_90 = open("ref_GL_Wiley_90.txt", "r")
...
for m in ref_file_GL_0:
    ...
    ref_GL_0.append(float(row[1])*float(row[0])*float(row[0])/0.990)


plt.plot(ref_r_GL_0,ref_GL_0,color='red',label='Ref. Data',linestyle='--', marker='x')
...
for m in ref_file_GL_10:
    ...
    ref_GL_10.append(float(row[1])*float(row[0])*float(row[0])/0.990)


plt.plot(ref_r_GL_10,ref_GL_10,color='red',label='Ref. Data',linestyle='--', marker='x')
...
for m in ref_file_GL_20:
    ...
    ref_GL_20.append(float(row[1])*float(row[0])*float(row[0])/0.990)


plt.plot(ref_r_GL_20,ref_GL_20,color='red',label='Ref. Data',linestyle='--', marker='x')
...
for m in ref_file_GL_30:
    ...
    ref_GL_30.append(float(row[1])*float(row[0])*float(row[0])/0.990)


plt.plot(ref_r_GL_30,ref_GL_30,color='red',label='Ref. Data',linestyle='--', marker='x')
...
for m in ref_file_GL_40:
    ...
    ref_GL_40.append(float(row[1])*float(row[0])*float(row[0])/0.990)



plt.plot(ref_r_GL_40,ref_GL_40,color='red',label='Ref. Data',linestyle='--', marker='x')
...
for m in ref_file_GL_50:
    ...
    ref_GL_50.append(float(row[1])*float(row[0])*float(row[0])/0.990)


plt.plot(ref_r_GL_50,ref_GL_50,color='red',label='Ref. Data',linestyle='--', marker='x')
...
for m in ref_file_GL_60:
    ...
    ref_GL_60.append(float(row[1])*float(row[0])*float(row[0])/0.990)


plt.plot(ref_r_GL_60,ref_GL_60,color='red',label='Ref. Data',linestyle='--', marker='x')
...
for m in ref_file_GL_70:
    row = m.split()
    ref_r_GL_70.append(float(row[0]))
    #ref_GL_70.append(float(row[1]))
    ref_GL_70.append(float(row[1])*float(row[0])*float(row[0])/0.990)


plt.plot(ref_r_GL_70,ref_GL_70,color='red',label='Ref. Data',linestyle='--', marker='x')
...
for m in ref_file_GL_80:
    row = m.split()
    ref_r_GL_80.append(float(row[0]))
    #ref_GL_80.append(float(row[1]))
    ref_GL_80.append(float(row[1])*float(row[0])*float(row[0])/0.990)


plt.plot(ref_r_GL_80,ref_GL_80,color='red',label='Ref. Data',linestyle='--', marker='x')
...
for m in ref_file_GL_90:
    ...
    ref_GL_90.append(float(row[1])*float(row[0])*float(row[0])/0.990)

plt.plot(ref_r_GL_90,ref_GL_90,color='red',label='Ref. Data',linestyle='--', marker='x')
